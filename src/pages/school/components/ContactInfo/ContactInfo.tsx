    ...
    <Fragment>
      <div className={styles.container}>
        <ul className={styles['contact-list']}>
          <ContactItem
            contactInfo={website && website !== null ? website : ""}
            label='Website'
            tooltip='Copy Website Link'
            onCopyClick={
              () => copyToClipboard({
                text: website && website !== null ? website : "",
          ...
          <ContactItem
            contactInfo={phone && phone !== null ? phone : ""}
            label='Phone'
            tooltip='Copy Phone Number'
            onCopyClick={
              () => copyToClipboard({
                text: phone && phone !== null ? phone : "",
          ...
          <ContactItem
            contactInfo={mobile && mobile !== null ? mobile : ""}
            label='Mobile'
            tooltip='Copy Mobile Number'
            onCopyClick={
              () => copyToClipboard({
                text: mobile && mobile !== null ? mobile : "",
          ...
          <ContactItem
            contactInfo={mail && mail !== null ? mail : ""}
            label='Email'
            tooltip='Copy Email'
            onCopyClick={
              () => copyToClipboard({
                text: mail && mail !== null ? mail : "",
