...
const Typography = ({
  ...
  const Component: ElementType | string = component ? component : variantMapping[variant]
  const WrapperElem: ElementType | string = adorn && (variant === 'h1' || variant === 'h2') ? 'div' : Fragment
    ...
    >
      ...
      </Component>
      {
        adorn && (variant === 'h1' || variant === 'h2') ? (
          <svg className={styles['adorn']} width="200" height="79" viewBox="0 0 200 79" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path 
